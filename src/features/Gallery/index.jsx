...
export default function Gallery() {
  ...
  const [srcSet] = useState([
    "/assets/images/mock-01.png",
    "/assets/images/mock-02.png",
    "/assets/images/mock-03.png",
    "/assets/images/mock-04.png",
    "/assets/images/mock-05.png",
    "/assets/images/mock-06.png",
  ]);
